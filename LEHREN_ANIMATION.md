...
**EL18. Statisches Hinstellen ist der Standardfehler blinder Sessions (Autorbefund 2026-09-05, Blindfilm 2).** Ein Film kann alle mechanischen Prüfungen bestehen (0/0/0, lauf2 grün) und didaktisch ungenügend sein: null Bewegungs-Geräte, null Merksätze, Antwort vor der Not, leere payoff-Beats, Übersichts-Anlauf statt lebender Frage. Gegenkraft: je Gleichung die Beziehungsfrage (welche Zahl bewegt sich, woher, wohin) als Pflichtdurchgang im Skill, Serien-Konsolidierung als Prüferregel, Simulat-Lauf vor jeder Abgabe (EL16). Blindtests messen nur mit themenfremdem Beispiel (Blind-1 mit themengleichem Maßbeispiel misst Abschreiben und verschlechtert dabei noch: doppelte Last je Blatt, teure Bewegung mehrfach gegen AL18).

**EL19. Das Inventar entsteht nie im selben Kopf wie der Film (G6.1, bereinigt durch B19).** Wer Inventar und Film zusammen erzeugt, prüft die Abdeckung gegen die eigene Lücke. Das Inventar ist ein eigener, blinder Schritt vor der Reise: nur die Seiten, wortgetreu, seitenweise mit Marken; der Filmkopf bekommt es als Pflichtliste. (Der konkrete Auslassungs-Vorwurf an Blindfilm 2 war falsch, die Quelle war das kleine Vier-Seiten-Dokument und der Film dort treu; die Prozesslehre bleibt richtig. Bei Seitenangaben immer die Datei nennen, die Zählungen der Dokumente weichen ab.)

**EL20. Übersicht ist ein Ventil, kein Freifahrtschein (G6.4).** Höchstens ein Übersichtsblatt je Film, nie als Eröffnung, und nur, wenn der Film den Katalog danach abarbeitet; sonst fällt der Katalog oder wird stehende Karte. Zwei Übersichtsblätter in Folge sind der L36-Anlauf in neuer Form.

**EL21. Ein Katalog in der Oberflächenform des Beispiels erzeugt Gerätevermeidung (G6.3).** Mimikry mit umgekehrtem Vorzeichen: Fehlt die Oberfläche des Beispiels, lässt die blinde Session das Gerät weg und begründet es didaktisch. Gegenkraft: Beziehungen richtungsfrei beschreiben (eine Zahl, die an einer Stelle steht, taucht an einer anderen auf; zeige den Weg, gleich ob Formel zu Formel, Formel zu Bild oder Bild zu Formel) plus je Gerät Miniaturen aus fremden Themen (L26); dazu der Umkehrschluss als Regel: eine Beziehung im Dokument ohne Gerät ist ein Fehler.

**AL19. Bewegung nur, wo der Leser sich etwas nicht selbst denken kann (G6.10, Simulat-Beleg).** Die Umformung 4−4=0 trägt nichts (hat der Leser im Kopf), der Graph von x⁴−2x² trägt (kann er sich nicht vorstellen). Trivialschritte bekommen keine Choreographie; die Strecke eines Beats folgt seinem Inhalt (B18: jedes Stück kostet dieselbe Radstrecke; Autorbefund: viel Scrollen für mindere Wirkung ist ein Befund, kein Stil).
